...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	[0]  = { MAX_AXI, 0, 0,    825000, 850000, 0},
	[1]  = { 432000,  1, 0x08, 850000, 875000, 0},
	[2]  = { 486000,  1, 0x09, 875000, 900000, 0},
	[3]  = { 540000,  1, 0x0A, 875000, 900000, 0},
	[4]  = { 594000,  1, 0x0B, 900000, 925000, 0},
	[5]  = { 648000,  1, 0x0C, 925000, 950000, 1},
	[6]  = { 702000,  1, 0x0D, 950000, 975000, 1},
	[7]  = { 756000,  1, 0x0E, 975000, 1000000, 1},
	[8]  = { 810000,  1, 0x0F, 975000, 1000000, 1},
	[9]  = { 864000,  1, 0x10, 1000000, 1025000, 1},
	[10] = { 918000,  1, 0x11, 1025000, 1050000, 2},
	[11] = { 972000,  1, 0x12, 1050000, 1075000, 2},
	[12] = {1026000,  1, 0x13, 1075000, 1100000, 2},
	[13] = {1080000,  1, 0x14, 1075000, 1100000, 2},
	[14] = {1134000,  1, 0x15, 1100000, 1125000, 2},
	[15] = {1188000,  1, 0x16, 1150000, 1175000, 3},
	[16] = {1242000,  1, 0x17, 1150000, 1175000, 3},
	[17] = {1296000,  1, 0x18, 1175000, 1200000, 3},
	[18] = {1350000,  1, 0x19, 1175000, 1200000, 3},
	[19] = {1404000,  1, 0x1A, 1200000, 1225000, 4},
	[20] = {1458000,  1, 0x1B, 1225000, 1250000, 4},
	[21] = {1512000,  1, 0x1C, 1250000, 1275000, 4},
#ifdef CONFIG_NUTTER_MODE
	[22] = {1566000,  1, 0x1D, 1275000, 1300000, 4},
	[23] = {1620000,  1, 0x1E, 1300000, 1325000, 4},
	[24] = {1674000,  1, 0x1F, 1325000, 1350000, 4},
	[25] = {1728000,  1, 0x20, 1350000, 1375000, 4},
	[26] = {1836000,  1, 0x21, 1375000, 1400000, 4}
#endif
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
  ...
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x18, L2(17), 1225000, 0x03006000},
  ...
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(21), 1275000, 0x03006000},
#ifdef CONFIG_NUTTER_MODE
  ...
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(26), 1425000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(26), 1450000, 0x03006000},
#endif
  { {0, 0}, 0 },
};
...
static void __init scpll_init(int sc_pll)
{
	 ...
	 */
	regval = (L_VAL_SCPLL_CAL_MAX << 26) | (L_VAL_SCPLL_CAL_MIN << 16);
...
void __init msm_acpu_clock_init(struct msm_acpu_clock_platform_data *clkdata)
{
	...
	/* Improve boot time by ramping up CPUs immediately, this must be set within safe 
	*working limits removed "max_cpu_khz" as this will override policy->max parameters
	*/
